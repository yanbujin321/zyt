...
const helpContent = {
	...
	shellSize: {
		header: '外壳尺寸',
		body: '烟花的大小。以真实的烟花弹尺寸为模型，较大的炮弹具有更大的爆发和更多的星星，有时效果更复杂。但是，较大的外壳也需要更多的处理能力，并且可能会导致滞后。'
	},
	quality: {
		header: '质量',
		body: '整体图形质量。如果动画运行不流畅，请尝试降低质量。高质量会大大增加渲染的火花数量，并可能导致滞后。'
	},
	skyLighting: {
		header: '天空照明',
	...
	scaleFactor: {
		header: '烟花规模',
		body: '允许缩放所有烟花的大小，基本上将您移近或更远。对于较大的外壳尺寸，可以方便地减小比例，尤其是在手机或平板电脑上'
	},
	autoLaunch: {
		header: '自动点火',
